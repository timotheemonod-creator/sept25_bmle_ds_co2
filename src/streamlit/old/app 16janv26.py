...
if slide_id == "contexte":
    ...
    with col1:
        st.metric(label=" 2010-2024", value=">91M", delta=None, delta_color="normal")
        st.caption("<span style='color:#F54927; font-weight:600;'>40 colonnes initiales</span>", unsafe_allow_html=True)
    with col2:
        st.metric(label=" Focus 2022", value="9,48M", delta=None, delta_color="normal")
        st.caption("<span style='color:#F54927; font-weight:600;'>Volume exploitable</span>", unsafe_allow_html=True)
    with col3:
        st.metric(label=" Doublons supprimés", value="533K", delta=None, delta_color="inverse")
        st.caption("<span style='color:#F54927; font-weight:600;'>17 colonnes</span>", unsafe_allow_html=True)
    with col4:
        st.metric(label=" Cible Ewltp priorisée", value="1% NA", delta=None, delta_color="off")
        st.caption("<span style='color:#F54927; font-weight:600;'>Enedc ≈ 82% NA</span>", unsafe_allow_html=True)
    st.markdown('<hr style="border: none; border-top: 3px solid #F54927; margin: 1.2em 0;" />', unsafe_allow_html=True)
...
if slide_id == "demo":
    ...
    with col_left:
        ...
        with st.form("demo_form"):
            ...
            year = st.selectbox("Année", list(range(2010, 2026)))
